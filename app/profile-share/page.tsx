      ...
      <Container>
        <div className="flex py-10">
          <div className="xl:w-20 lg:w-20 md:w-20 w-16 flex flex-col items-center justify-center h-max bg-[#B0AFAF] p-4 rounded-xl space-y-4">
            ...
            <div className="w-[30px] h-10 flex items-center justify-center">
              <Image src="assets/faCreditCard.svg" alt="" className="w-full h-full object-contain" />
            </div>
            <div className="w-[30px] h-10 flex items-center justify-center">
              <Image src="assets/faUserPlus-black.svg" alt="" className="w-full h-full object-contain" />
            </div>
            <div className="w-[30px] h-10 flex items-center justify-center">
              ...
              <div className="relative">
                ...
                <div className="flex items-center bg-gray-200 w-full px-3 py-2 mt-4">
                  <div className="w-6 h-6">
                    <Image src="assets/Invite.svg" alt="" className="w-full h-full object-contain" />
                  </div>
            ...
            <div className="flex items-center xl:justify-end lg:justify-end md:justify-end justify-between xl:text-right lg:text-right md:text-right text-left mt-10 xl:flex-nowrap lg:flex-nowrap md:flex-wrap flex-wrap">
              ...
              <ul className="flex items-center space-x-2">
                <li className="w-8 h-8">
                  <Image src="assets/Messages.svg" alt="" className="w-full h-full object-contain" />
                </li>
                <li className="w-8 h-8">
                  <Image src="assets/Instagram.svg" alt="" className="w-full h-full object-contain" />
                </li>
                <li className="w-8 h-8">
                  <Image src="assets/WhatsApp.svg" alt="" className="w-full h-full object-contain" />
                </li>
              </ul>
            </div>
