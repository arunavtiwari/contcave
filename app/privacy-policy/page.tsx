                ...
                <div className="pt-10 pb-60">
                    <div className="container mx-auto mt-8 p-8 bg-white shadow-lg space-y-6">
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                            <li><strong>Personal Information:</strong> Name, email, phone number, payment details, and other account-related data.</li>
                            <li><strong>Usage Data:</strong> IP address, device details, and browsing activity on our platform.</li>
                            <li><strong>Cookies & Tracking:</strong> We use cookies to enhance your experience and analyze usage trends.</li>
                        </ul>
