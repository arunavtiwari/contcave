...
const Clause = ({ id, children }: { id: string; children: React.ReactNode }) => (
    <p className="text-gray-700 text-sm leading-relaxed">
        <span className="font-medium text-gray-800">{id}</span> {children}
    </p>
);
    ...
    <div className="pl-6 space-y-1">
        {items.map((item, i) => (
            <p key={i} className="text-gray-700 text-sm leading-relaxed">
                <span className="font-medium text-gray-800">({String.fromCharCode(97 + i)})</span> {item}
            </p>
        ))}
    </div>
);
                                ...
                                <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                                    <thead>
                                        <tr className="bg-gray-50">
                                            <th className="text-left px-4 py-3 font-semibold text-gray-700 border-b border-gray-200">Cancellation Timing</th>
                                            <th className="text-left px-4 py-3 font-semibold text-gray-700 border-b border-gray-200">Refund</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className="px-4 py-3 text-gray-700 border-b border-gray-100">More than 72 hours before booking start time</td>
                                            <td className="px-4 py-3 text-green-700 font-medium border-b border-gray-100">Full refund (100%)</td>
                                        </tr>
                                        <tr>
                                            <td className="px-4 py-3 text-gray-700 border-b border-gray-100">Between 24 and 72 hours before booking start time</td>
                                            <td className="px-4 py-3 text-yellow-700 font-medium border-b border-gray-100">50% refund</td>
                                        </tr>
                                        <tr>
                                            <td className="px-4 py-3 text-gray-700">Less than 24 hours before booking start time</td>
                                            <td className="px-4 py-3 text-red-700 font-medium">No refund (0%)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
