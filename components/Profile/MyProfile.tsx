                            ...
                            <div className="flex justify-between items-center">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        disabled={!editMode}
                                        className="bg-transparent focus:outline-none focus:ring-0 placeholder-slate-400 w-24"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {editMode ? (
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="border border-gray-300 rounded-lg px-3 py-2 w-48 focus:ring-2 focus:ring-black focus:border-transparent outline-none"
