          ...
          <div className="grid place-items-center md:place-items-start gap-8">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                <input type="email" placeholder="Enter your email" className="bg-background border border-border py-2 px-4 rounded-full" />
                <button className="bg-primary text-primary-foreground px-8 py-2 rounded-full hover:opacity-90 cursor-pointer transition-opacity">Subscribe</button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-6 text-sm font-medium text-center md:text-left">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                <Link href="/home" className="text-muted-foreground hover:text-foreground transition-all text-sm font-semibold italic">View All Cities</Link>
              </div>
            </div>
          </div>
        </div>
      </Container>
      <div className="bg-primary text-primary-foreground py-2 text-sm text-center">
